<table>
    <thead>
    <tr>
        <th style="width: 50px; border: 1px solid #000; text-align: center; padding: 8px; font-size: 12px; font-weight: bold;">
            #
        </th>
        <th style="width: 50px; border: 1px solid #000; text-align: center; padding: 8px; font-size: 12px; font-weight: bold;">
            ID
        </th>
        <th style="width: 200px; border: 1px solid #000; text-align: center; padding: 8px; font-size: 12px; font-weight: bold;">
            ФИО
        </th>
        <th style="width: 200px; border: 1px solid #000; text-align: center; padding: 8px; font-size: 12px; font-weight: bold;">
            Должность
        </th>
        <th style="width: 100px; border: 1px solid #000; text-align: center; padding: 8px; font-size: 12px; font-weight: bold;">
            Оклад
        </th>
        <th style="width: 100px; border: 1px solid #000; text-align: center; padding: 8px; font-size: 12px; font-weight: bold;">
            Аванс
        ...
        <th style="width: 150px; border: 1px solid #000; text-align: center; padding: 8px; font-size: 12px; font-weight: bold;">
            Ставка за час
        </th>
        <th style="width: 100px; border: 1px solid #000; text-align: center; padding: 8px; font-size: 12px; font-weight: bold;">
            Оплата
    ...
    <tbody>
    @foreach($groupedSalaryPayEmployees as $groupName => $payEmployees)
        <tr>
            <td colspan="9"
                style="border: 1px solid #000; background-color: #e9ecef; text-align: left; padding: 8px; font-size: 16px;">
                {{ $groupName }}
            </td>
        </tr>
        ...
        @endforeach
        <tr>
            <td colspan="5" style="border: 1px solid #000; text-align: left; padding: 8px; font-size: 12px;">Итого</td>
            <td style="border: 1px solid #000; text-align: left; padding: 8px; font-size: 12px; font-weight: bold;">{{ $payEmployees->sum('advance') }}</td>
            <td colspan="2" style="border: 1px solid #000; text-align: left; padding: 8px; font-size: 12px;"></td>
            <td style="border: 1px solid #000; text-align: left; padding: 8px; font-size: 12px; font-weight: bold;">{{ $payEmployees->sum('salary_pay') }}</td>
        </tr>
    @endforeach

    <tr>
        <td colspan="5" style="border: 1px solid #000; text-align: left; padding: 8px; font-size: 12px;">Всего</td>
